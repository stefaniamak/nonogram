...
class LineSolverSimpler {
  ...
  void solve(Nonogram nonogram) async {
    NonogramState state = useNonogramState(nonogram);

    state.updateStartingDateTime(DateTime.now());
    // final DateTime startingDateTime = DateTime.now();
    ...
    // final DateTime endingDateTime = DateTime.now();
  }
